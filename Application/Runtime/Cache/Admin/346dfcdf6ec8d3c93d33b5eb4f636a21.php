                            ...
                            <table class="table">
                                ...
                                <tbody id="flag">
                                    ...
                                    <tr>
                                        ...
                                        <td><input type="number" required class="form-control1" id="inputPassword1" name="goods_price">                                            </td>

                                    </tr>
                                    <tr>
                                        <th scope="row">商品重量KG</th>
                                        <td><input type="number" required class="form-control1" id="inputPassword2" name="goods_weight"></td>
                                    </tr>
                                    <tr>
                                        <th scope="row">商品数量KG</th>
                                        <td><input type="number" required class="form-control1" id="inputPassword2" name="goods_number"></td>
                                    </tr>

                                    <tr>
                                        <th scope="row">上传商品Logo</th>
                                        <td><input type="file" id="exampleInputFile" name="logo"></td>
                                    </tr>
                                    <tr>
                                        <th scope="row">上传商品图册</th>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <select name="type_id" id="type_sel" class="form-control1">
                                                ...
                                                <?php if(is_array($type_info)): foreach($type_info as $key=>$v): ?><option value="<?php echo ($v['type_id']); ?>" ><?php echo ($v["type_name"]); ?></option><?php endforeach; endif; ?>
									        </select>
                                        </td>
                                    </tr>
...
<script>
        ...
        $("#type_sel").change(function (e) {
            ...
            if (type_id == 0) {
                ...
                $.ajax({
                    type: "post",
                    url: "<?php echo U('Attribute/showlist');?>",
        ...
        function getString(array) {
            ...
            for (var index = 0; index < array.length; index++) {
                ...
                if (v['attr_sel'] == "only") {
                    s += "<td><input type='text' required class='form-control1' id='focusedinput' name='attrs[" + v['attr_id'] + "]'></td>";
                }
                else {
