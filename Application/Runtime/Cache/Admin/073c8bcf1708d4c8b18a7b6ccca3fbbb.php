                ...
                <div class="panel-body widget-shadow">
                    ...
                    <table class="table">
                        ...
                        <tbody>
                            <tr>
                                <th scope="row">MID</th>
                                <td><?php echo ($info["mg_id"]); ?></td>
                                <td>管理员ID</td>
                            </tr>
                            <tr>
                                <th scope="row">账号</th>
                                <td><?php echo ($info["mg_name"]); ?></td>
                                <td>用于登录的用户名</td>
                            </tr>
                            <tr>
                                <th scope="row">盐值</th>
                                <td><?php echo ($info["mg_salt"]); ?></td>
                                <td>用于加密密码的盐值，使用盐值算法，具体算法为原密码加上盐值的hash值再进行md5加密</td>
                            </tr>
                            <tr>
                                <th scope="row">创建时间</th>
                                <td><?php echo (date("y-m-d H:i:s",$info["mg_time"])); ?></td>
                                <td>创建该账号的公元时间</td>
                            </tr>
                            <tr>
                                <th scope="row">管理组ID</th>
                                <td><?php echo ($info["role_id"]); ?></td>
                                <td>管理组代码，不同管理组权限不同，具体可参见角色列表或询问超级管理员</td>
                            </tr>
                            <tr>
                                <th scope="row">管理组名称</th>
                                <td><?php echo ($info["role_name"]); ?></td>
                                <td>管理组名称，不同管理组权限不同，具体可参见角色列表或询问超级管理员</td>
                            </tr>
                            <tr>
                                <th scope="row">拥有的权限代号</th>
                                <td><?php echo ($info["role_auth_ids"]); ?></td>
                                <td>该账号拥有的权限，具体可参见权限列表或询问超级管理员</td>
                            </tr>
                            <tr>
                                <th scope="row">控制器-方法</th>
                                <td><?php echo ($info["role_auth_ac"]); ?></td>
