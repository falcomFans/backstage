...
<html>
<head>
<title>秋名山车队后台登录系统</title>
<link href="<?php echo C('CSS_URL');?>style1.css" rel="stylesheet" type="text/css" media="all"/>
...
<!--footer-->
<div class="footer">
	<p>&copy; 2017 Transparent Login Form. All rights reserved | Design by <a href="https://www.baidu.com/s?wd=falcom">Falcom</a></p>
</div>
<!--//footer-->
