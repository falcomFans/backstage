                ...
                <div class="panel-body widget-shadow">
                    ...
                    <table class="table">
                        ...
                        <?php if(is_array($info)): foreach($info as $k=>$v): ?><tr>
                                ...
                                <td>
                                    <?php if(($_SESSION['admin_id']) == "503"): ?><a href="<?php echo U('edit',array('id'=>$v['order_id']));?>">编辑</a>丨<?php endif; ?>
                                    <a href="<?php echo U('showinfo',array('id'=>$v['order_id']));?>">查看</a> |
                                    
                                    <button type="button" id="<?php echo ($v['order_id']); ?>" onclick="bind(this)" class="btn btn-info">绑定快递</button>
