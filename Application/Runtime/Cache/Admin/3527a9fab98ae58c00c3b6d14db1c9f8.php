                ...
                <div class="panel-body widget-shadow">
                    ...
                    <table class="table">
                        ...
                        <?php if(is_array($info)): foreach($info as $k=>$v): ?><tr>
                                <th scope="row"><?php echo ($v["level_name"]); ?></th>
                                <td><?php echo ($v["level_rate"]); ?></td>
                                <td><?php echo ($v["jifen_bottom"]); ?></td>
                                <td><?php echo ($v["jifen_top"]); ?></td>
                                <td>
                                    <?php if(($_SESSION['admin_id']) == "503"): ?><a href="<?php echo U('edit',array('id'=>$v['mg_id']));?>">编辑</a>丨<?php endif; ?>
                                    <a href="<?php echo U('showinfo',array('id'=>$v['mg_id']));?>">查看</a></td>
