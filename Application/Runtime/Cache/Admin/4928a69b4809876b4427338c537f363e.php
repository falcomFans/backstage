                ...
                <div class="tables">
                    ...
                    <div class="panel-body widget-shadow">
                        ...
                        <table class="table">
                            ...
                            <tbody>
                                <?php if(is_array($authAA)): foreach($authAA as $k=>$v): ?><tr bgcolor="MistyRose">
                                        <th scope="row"><?php echo ($v["auth_id"]); ?></th>
                                        <td><?php echo ($v["auth_name"]); ?></td>
                                        <td><?php echo ($v["auth_pid"]); ?></td>
                                        <td><?php echo ($v["auth_c"]); ?>-<?php echo ($v["auth_a"]); ?></td>
                                        <td>
                                            <?php echo ($v["auth_level"]); ?>
                                        </td>
                                    </tr>

                                    <?php if(is_array($authBB)): foreach($authBB as $key=>$vv): if(($vv['auth_pid']) == $v['auth_id']): ?><tr>
                                                <th scope="row"><?php echo ($vv["auth_id"]); ?></th>
                                                <td>-------- <?php echo ($vv["auth_name"]); ?></td>
                                                <td><?php echo ($vv["auth_pid"]); ?></td>
                                                <td><?php echo ($vv["auth_c"]); ?> - <?php echo ($vv["auth_a"]); ?></td>
                                                <td>
                                                    <?php echo ($vv["auth_level"]); ?>
                                                </td>
