...
<div class="main-content">
    ...
    <div id="page-wrapper">
        <div class="main-page">
            <div class="tables">
                <h3 class="title1">商品类型</h3>
                <div class="panel-body widget-shadow">
                    
                    <a href="<?php echo U('add');?>"> <button type="button" class="btn btn-lg btn-success">点我添加类型</button></a>
                     <br><br>             
                    <table class="table">
                        <thead>
                        <tr>
                        ...
                        <?php if(is_array($info)): foreach($info as $k=>$v): ?><tr>
                                ...
                                <td>
                                    <a href="<?php echo U('edit',array('id'=>$v['role_id']));?>">编辑</a>
                                    <?php if(($v['role_id']) != "1"): ?>丨<a href="<?php echo U('del',array('id'=>$v['role_id']));?>" onclick="return confirm('真的要删除吗')">删除</a><?php endif; ?>
                                </td>
