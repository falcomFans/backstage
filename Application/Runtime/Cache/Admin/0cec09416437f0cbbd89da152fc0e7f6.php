            ...
            <div class="main-page">
                <div class="tables">
                    ...
                    <div class="panel-body widget-shadow">
                        <a href="<?php echo U('add');?>"> <button type="button" class="btn btn-lg btn-success">点我添加属性</button></a>
                        <br><br>
                        <div class="col-sm-3">
                            <select name="" id="select1" class="form-control" required="required">
                                <option value="">所有类型</option>
                                <?php if(is_array($type)): foreach($type as $key=>$vv): ?><option value="<?php echo ($vv['type_id']); ?>"><?php echo ($vv['type_name']); ?></option><?php endforeach; endif; ?>
                            </select>
                        </div>
                        <br><br>
                        ...
                        <table class="table">
                            ...
                            <tbody id="tbody">
                                <?php if(is_array($info)): foreach($info as $k=>$v): ?><tr>
                                        ...
                                        <td><?php echo ($v["attr_write"]); ?></td>
                                        <td><?php echo ($v["attr_vals"]); ?></td>
                                        <td>
