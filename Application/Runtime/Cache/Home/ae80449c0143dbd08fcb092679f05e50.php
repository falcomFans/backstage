...
<head>
	...
	<link href="<?php echo C('CSS_URL');?>jsstyle.css" rel="stylesheet" type="text/css" />

	<script type="text/javascript" src="<?php echo C('JS_URL');?>address.js"></script>
		...
		<div class="concent">
			...
			<div class="paycont">
				...
				<div class="logistics">
					<h3>选择支付方式</h3>
					<ul class="pay-list">
						<li class="pay card"><img src="<?php echo C('IMG_URL');?>wangyin.jpg" />银联<span></span></li>
						<li class="pay qq"><img src="<?php echo C('IMG_URL');?>weizhifu.jpg" />微信<span></span></li>
						<li class="pay taobao"><img src="<?php echo C('IMG_URL');?>zhifubao.jpg" />支付宝<span></span></li>
					</ul>
				</div>
				<div class="clear"></div>
											...
											<li class="td td-item">
												...
												<div class="item-info">
													<div class="item-basic-info">
														<a href="<?php echo U('Goods/detail',array('id'=>$v['goods_id']));?>" target="_blank" title="<?php echo ($v['good_name']); ?>" class="item-title J_MakePoint"
														 data-point="tbcart.8.11"><?php echo ($v['good_name']); ?></a>
													</div>
												</div>
											</li>
											<li class="td td-info">
						...
						<div class="pay-confirm clearfix">
							<div class="box">
								<div tabindex="0" id="holyshit267" class="realPay"><em class="t">实付款：</em>
                                    ...
                                    <span>¥</span> <em class="style-large-bold-red " id="J_ActualFee"><?php echo ($number_price['price']); ?></em>
									</span>
								</div>
							...
							<div id="holyshit269" class="submitOrder">
								<div class="go-btn-wrap">
									<a id="J_Go" href="<?php echo U('successPay');?>" class="btn-go" tabindex="0" title="点击此按钮，提交订单">提交订单</a>
								</div>
							</div>
							<div class="clear"></div>
						</div>
